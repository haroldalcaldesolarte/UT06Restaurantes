import {Allergen} from "../entities/allergen.js";
...
export {Manager};
export {Allergen} from '../entities/allergen.js';
export {Category} from '../entities/category.js';
export {Coordinate} from '../entities/coordinate.js';
export {Dish} from '../entities/dish.js';
export {Menu} from '../entities/menu.js';
export {Restaurant} from '../entities/restaurant.js';